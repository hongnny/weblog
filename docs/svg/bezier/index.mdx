...
import {RenderImg} from '@site/src/common/index.js'
...
<RenderImg
  src={require('./img/bezier1.gif')}
  text="线性贝塞尔曲线, t在[0,1]"
   width="300px"/>
<RenderImg src={require('./img/bezier2.gif')}
  text="二次贝塞尔曲线, t在[0,1]"
   width="300px"/>
<RenderImg src={require('./img/bezier3.gif')}
  text="三次贝塞尔曲线, t在[0,1]"
   width="300px"/>
<RenderImg src={require('./img/bezier4.gif')}
  text="四次贝塞尔曲线, t在[0,1]"
   width="300px"/>
<RenderImg src={require('./img/bezier5.gif')}
  text="五次贝塞尔曲线, t在[0,1]"
   width="300px"/>
...
<RenderImg
  width="600px"
  src={require('./img/bezier3-example.png')}/>
...
<RenderImg
  width="300px"
  src={require('./img/bezier3-sc.png')}/>
...
<RenderImg
  width="300px"
  src={require('./img/bezier2-qt.png')}/>
