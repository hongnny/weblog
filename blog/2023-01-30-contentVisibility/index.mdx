...
<RenderImg
  src={require('./img/content.visibility.1.gif')}/>
...
<RenderImg
  src={require('./img/content.visibility.4.gif')}/>
...
<RenderImg
  src={require('./img/content.visibility.5.gif')}/>
